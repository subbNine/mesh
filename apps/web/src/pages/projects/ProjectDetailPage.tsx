            ...
            {isEditingDetails ? (
              ...
              >
                ...
                <textarea
                  ...
                  placeholder="Focus on milestone..."
                />
                <div className="flex items-center gap-2 mt-1">
                  <Button size="sm" onClick={handleUpdateDetails} loading={isSaving}>Update Project</Button>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-[0.15em] text-primary">
                  <Layout size={10} fill="currentColor" /> Project
                </div>
                ...
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                  <p className="text-[11px] text-muted-foreground font-serif italic max-w-sm truncate opacity-70">
                    {currentProject.description || 'Focus on milestones that matter most.'}
                  </p>
